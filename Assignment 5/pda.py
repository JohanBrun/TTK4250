...
class PDA(Generic[ET]):  # Probabilistic Data Association
    ...
    def gate(
        ...
        *,
        ...
        gated = np.array([
            ...
            for zj in Z
        ], dtype=bool) # TODO: some for loop over elements of Z using self.state_filter.gate
        return gated
    ...
    def loglikelihood_ratios(
        ...
        *,
        ...
        ll[0] = log_PND + log_clutter # TODO: missed detection
        ll[1:] = np.array([
            self.state_filter.loglikelihood(zj, filter_state, sensor_state=sensor_state)
            for zj in Z
    ...
    def reduce_mixture(
        ...
        return self.state_filter.reduce_mixture(mixture_filter_state) # TODO: utilize self.state_filter to keep this working for both EKF and IMM
    ...
    def update(
        ...
        *,
        ...
        gated = self.gate(Z, filter_state, sensor_state=sensor_state) # TODO
        Zg = Z[gated]
    ...
    def step(
        ...
        *,
        ...
        filter_state_updated = self.update(Z, filter_state_predicted, sensor_state=sensor_state) # TODO
